...
public class RemoteSyncService {
    ...
    public int syncFromGitHub(com.thiz.commitstory.entity.GitRepo repo) {
    ...
    private CommitEntry mapCommit(com.thiz.commitstory.entity.GitRepo repo, Map<String, Object> ghCommit,
